...
// Alle Eintragungen
$queryAccsses = '
		SELECT `id`, `user_id`, `day_id`,`email`, `position` ,`first_name`,`last_name`,`date`
...
gerechten Wachplan erstellt. Dabei wurdest du für folgende Termine eingeteilt:\n\n";
 ...
 damit wir diese Problem lösen können. Auch wenn es Problem während oder mit dem Wachdienst gibt
 kannst du dich gerne an einen von uns wenden.\n\n Viele Grüße und viel Spaß beim Wachdienst\n Deine Wachdienstleitung";
